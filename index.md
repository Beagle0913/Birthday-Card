...
2. **Répétition** : lire le bloc → **réciter à voix haute 3 fois** (sans regarder) → **cacher** → **réciter encore**. Si c’est encore flou, refaire.
...
- **MR²TE (Mutation, Recombinaison, Réparation, Transfert, Eléments transposables)**  
  Ce sont les **cinq forces** qui font **évoluer** les génomes : le **taux de mutation** (erreurs de réplication, mutagènes), la **recombinaison** (méiose, brassage), la **réparation** de l’ADN (qui module la fidélité), le **transfert horizontal** de gènes (surtout chez les bactéries), et la **mobilité des éléments transposables** (séquences qui se déplacent). Ce ne sont pas des « types de mutations » mais les **processus** qui introduisent ou modifient la variabilité.
...
- **Noyau, bâtons, H-D-T**  
  Chez les **eucaryotes**, l’ADN est dans le **noyau**, réparti sur **plusieurs chromosomes** le plus souvent **linéaires**. La **ploïdie** indique combien d’exemplaires du génome il y a : **H**aploïde = 1 (ex. gamètes), **D**iploïde = 2 (ex. humain), **T**étraploïde = 4 (certaines plantes).
...
- **D4-140, M10-5k, S12-90k, L16-12, H23-3k**  
  Ce sont des **exemples** à connaître : **D**rosophile 4 chr. / 140 Mb, **M**aïs 10 / 5 000 Mb, **S**alamandre 12 / 90 000 Mb, **L**evure 16 / 12,1 Mb, **H**omme 23 / 3 000 Mb. Ils illustrent que nombre de chromosomes et taille du génome varient de façon indépendante.
...
- **3 – 23 – 22 – 2**  
  **3** 000 Mb (ou 3 000 000 kb) de génome haploïde ; **23** chromosomes (haploïde) ; environ **22** 000 gènes codant des protéines ; environ **2 %** (1,5–2 %) du génome en régions codantes. Ce sont les **chiffres clés** à retenir pour l’humain.
...
- **RSI = 2G**  
  La **2ᵉ génération** regroupe des techniques comme **R**oche 454, **S**OLID, **I**llumina (la plus utilisée). Elles produisent des **très nombreux** reads en parallèle.

- **PO = 3G**  
  La **3ᵉ génération** : **P**acBio et **O**xford Nanopore. Les lectures sont **beaucoup plus longues** (plusieurs kb), mais le **taux d’erreur** brut est plus élevé (améliorable par consensus, ex. HiFi).
...
- **EFBSA**  
  **E**xtraction de l’ADN → **F**ragmentation **aléatoire** → construction de **B**anques de clones (par taille) → **S**équençage des inserts → **A**ssemblage des lectures (par chevauchements). C’est l’ordre logique du **Whole Genome Shotgun**.
...
|---|----------------------------|----------------------|
| 1 | **CMT** | Génome = ADN pour **C**onstruire, **M**aintenir, **T**ransmettre la cellule |
| 2 | **Winkler 20** | **Winkler** (1920) : génome = **gène + chromosome** |
| 3 | **Dujon : M-D-M** | **M**émoire du passé, **D**éterminant du présent, **M**oteur de l’évolution |
...
|---|----------------|---------------|
| 1 | **MR²TE** | Les 5 forces : **M**utation, **R**ecombinaison, **R**éparation, **T**ransfert horizontal, **E**léments transposables |
...
| 3 | **Noyau, bâtons, H-D-T** | Eucaryote : **noyau** ; chromosomes **linéaires** ; ploïdie **H**aploïde (1), **D**iploïde (2), **T**étraploïde (4) |
...
|----------------|-----------|------|------------|
| **D**4-140 | **D**rosophile | 4 | 140 |
| **M**10-5k | **M**aïs | 10 | 5 000 |
| **S**12-90k | **S**alamandre | 12 | 90 000 |
| **L**16-12 | **L**evure | 16 | 12,1 |
| **H**23-3k | **H**omme | 23 | 3 000 |
...
| 3 | **Micro 1–5, Mini 10–100, VNTR = empreinte** | **Micro**satellites : motifs 1–5 nt. **Mini**satellites / **VNTR** : 10–100 nt ; **empreintes génétiques** |
...
| 2 | **RSI = 2G** | 2ᵉ génération : **R**oche 454, **S**OLID, **I**llumina |
| 3 | **PO = 3G** | 3ᵉ génération : **P**acBio, **O**xford Nanopore |
...
| # | Mnémotechnique | Signification |
|---|----------------|---------------|
| 1 | **EFBSA** ou *« Étudiant Fait Beaucoup de Séquençage pour Assembler »* | **E**xtraction → **F**ragmentation aléatoire → **B**anques → **S**équençage → **A**ssemblage |
...
| 4 | **DéPôt** | **D**eux enzymes → **D**irectionnel (une seule orientation) + **P**as d’auto-refermeture du vecteur |
...
**Session 1 (≈ 15 min)**  
- Blocs 1 et 2. Lire → réciter 3× chaque bloc → cacher et réciter.

**Session 2 (≈ 20 min)**  
- Revoir Blocs 1 et 2 (réciter sans regarder).  
- Bloc 3. Même procédure.

**Session 3 (≈ 25 min)**  
- Revoir Blocs 1 à 3.  
- Blocs 4 et 5 (tableau D-M-S-L-H à écrire de mémoire).
...
**Session 5 (≈ 25 min)**  
- Revoir Blocs 1 à 8.  
- Blocs 9 et 10 (valeur C/G, 3-23-22-2).
...
**Session 7 (≈ 20 min)**  
- Revoir Blocs 11 à 13.  
- Blocs 14 et 15.

**Révision globale (avant l’examen)**  
- Parcourir uniquement la **colonne « Mnémotechnique »** de chaque bloc. Pour chaque ligne, dire à voix haute la signification. Si c’est flou, reprendre ce bloc pour 3× répétition.
